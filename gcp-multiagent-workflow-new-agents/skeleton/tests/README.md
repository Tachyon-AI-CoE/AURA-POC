# Test Suite for GCP Multi-Agent Workflow New Agents

This directory contains comprehensive unit tests for the GCP Multi-Agent Workflow New Agents project.
...
```bash
pytest tests/unit/test_log_helper.py -v
```

### Run specific test class:
```bash
pytest tests/unit/test_config_reader.py::TestConfigReader -v
```

### Run specific test method:
```bash
pytest tests/unit/test_log_helper.py::TestLogHelper::test_setup_logging_default_level -v
```

### Run with markers:
```bash
pytest tests/unit/ -m unit         # Run only unit tests
